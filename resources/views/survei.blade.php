...
<head>
    ...
    <link rel="stylesheet" href="css/styleSurvei.css">
    <title>Survei</title>
</head>
        ...
        <ul class="nav col-12 col-md-auto mb-2 justify-content-center mb-md-0">
          ...
          <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu menu-drop text-light">
                ...
                <li><a class="dropdown-item text-light pilihan-drop menu-layanan" href="survei">Survei</a></li>
              </ul>
          </li>
            ...
            <div class="accordion-item">
              <h2 class="accordion-header" id="headingTwo">
                <button class="accordion-button collapsed acc2" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                    Survei Demografi Majalengka Saber Hoaks
                </button>
              </h2>
              <div id="collapseTwo" class="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                <div class="accordion-body">
                    <div>
                        Survei Demografis Majalengka Saber Hoaks
                        <button class="btn btn-lihat">
                            Lihat
                        </button>
                    </div>               
